const LEVELS = [
    { min: 0, title: 'Iniciado', rank: 'Nivel 1', color: '#EFE9DE', icon: 'I' },
    { min: 3, title: 'Oyente Fiel', rank: 'Nivel 2', color: '#E8E0D2', icon: 'O' },
    { min: 7, title: 'Buscador', rank: 'Nivel 3', color: '#D1C7B5', icon: 'B' },
    { min: 15, title: 'Aprendiz', rank: 'Nivel 4', color: '#A8A29E', icon: 'A' },
    ...
    { min: 500, title: 'Ungido', rank: 'Nivel 10', color: '#141413', icon: 'U', textColor: 'text-white' }
];
