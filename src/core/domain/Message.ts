...
export type CanonicalSpeaker =
    ...
    | 'Esteban' | 'Saulo' | 'Jacobo' | 'Ananías' | 'Safira' | 'Gamaliel' | 'Simón'
    | 'Cornelio' | 'Lidia' | 'Agabo' | 'Tértulo' | 'Félix' | 'Festo' | 'Agripa'
    | 'Galión' | 'Demetrio' | 'Tribuno' | 'Escribano' | 'Filósofos' | 'Carcelero'
    | 'Adivina';
