...
export type CanonicalSpeaker =
    ...
    | 'Gad' | 'Ornán' | 'Jebuseos' | 'Amasai' | 'Abías' | 'Azarías' | 'Hanani' | 'Jahaziel' | 'Eliezer' | 'Amasías' | 'Oded' | 'Necao' | 'Ciro' | 'Cantores' | 'Tirsata' | 'Zorobabel' | 'Rehum' | 'Artajerjes' | 'Tatnai' | 'Secanías' | 'Darío' | 'Adversarios' | 'Abner' | 'Mical' | 'Merab' | 'Agag' | 'Eliab'
