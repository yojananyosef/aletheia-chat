...
- `src/` contiene el dominio: `views/`, `components/`, `hooks/`, `context/`, `core/` (`domain/Message.ts` es la fuente de verdad de hablantes y reglas de avance) y `constants/books.ts` (manifiesto del canon: 66 libros, 59 desbloqueados).
...
Estado del corpus: **59 / 66 libros publicados** (1.151 capítulos). Pendiente el resto del
Nuevo Testamento (7 libros, 43 capítulos) más los desbloqueos en `books.ts`.
