...
- `src/` contiene el dominio: `views/`, `components/`, `hooks/`, `context/`, `core/` (`domain/Message.ts` es la fuente de verdad de hablantes y reglas de avance) y `constants/books.ts` (manifiesto del canon: 66 libros, 49 desbloqueados).
...
Estado del corpus: **49 / 66 libros publicados** (1.103 capítulos). Pendiente el resto del
Nuevo Testamento (17 libros, 86 capítulos) más los desbloqueos en `books.ts`.
